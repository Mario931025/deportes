		...
		<div class="col-xl-12">
            ...
            <div class="card card-default">
				<div class="card-header">
					...
					<div class="row">
                        <div class="col-md-6">
                            <a href="{{ route('admin.countries.create') }}" class="btn btn-success">{{ __('Create') }}</a>
                        </div>
                        <div class="col-md-6">
                            <form method="GET" id="filter" action="{{ route('admin.countries.index') }}" accept-charset="UTF-8" class="form-inline float-right" role="search">
                                ...
                                @foreach ($countries as $country)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="{{ route('admin.countries.edit', $country->id) }}" class="btn btn-sm btn-info" data-toggle="tooltip" title="{{ __('Edit') }}"><em class="icon-pencil"></em></a>
